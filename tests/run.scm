(use test punycode utf8 extras srfi-1 test-generative)
...
(test-group "encoding properties"
  (test-generative ((str gen-unicode-string))
    (test-assert "encode + decode returns original string"
